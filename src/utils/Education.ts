...
export const EducationList: EducationDetailsType[] = [
  ...
  },
  {
    ...
    result: "https://cloud.appwrite.io/v1/storage/buckets/66241b72624e71cbcd6a/files/6643608d0010a73c4628/view?project=662415d3bdf8f8d8078b&mode=admin",
    isReverse: true
  },
  {
    date: "2013-2018",
    ...
    result: "https://cloud.appwrite.io/v1/storage/buckets/66241b72624e71cbcd6a/files/66435fc90027c5c25f53/view?project=662415d3bdf8f8d8078b&mode=admin",
    isReverse: false
  }
]
...
export const CodingProfiles: ItemsType[] = [
  {
    name: "LeetCode",
