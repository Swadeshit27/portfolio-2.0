            ...
            <Layout>
                ...
                <div className="w-full flex max-md:flex-col mt-4 mb-12 p-4">
                    <div className="md:w-2/5 max-md:mb-6 md:pe-8">
                        <div className="w-full h-[26rem] rounded-md bg-gradient-to-bl from-rose-500 via-blue-300 to-violet-500 flex justify-center items-center">
                    ...
                    <div className="md:w-3/5 md:px-8">
                        <div className="w-full h-[26rem] rounded-md bg-gradient-to-bl from-rose-500 via-blue-300 to-violet-500 flex justify-center items-center">
                            <div className='w-[99%] h-[99%] bg-black/80 backdrop-blur-lg rounded-md  p-4 sm:p-8'>
                                <form>
                                    <input type="text" placeholder='your name' className='w-full sm:w-[80%] outline-none rounded-md px-4 py-2 mb-3 capitalize' />
                                    <input type="email" placeholder='your email' className='w-full sm:w-[80%] rounded-md px-4 py-2 mb-3 ' />
                                    <input type="number" placeholder='your mobile number' className='w-full sm:w-[80%] rounded-md px-4 py-2 mb-3 ' />
                                    <textarea rows={5} placeholder='your message' className=' form-control w-full sm:w-[80%] rounded-md px-4 py-2 mb-3 ' />
                                </form>
                                <button className='w-24 py-2 text-lg  font-libre bg-violet-700 rounded-md capitalize'>send</button>
                            </div>
                        </div>
                    </div>
                </div>
