...
const ProjectCard = ({ project }: { project: ProjectsListType }) => {
    return (
        <div className="w-[20rem] max-sm:h-[19rem] h-[21rem] bg-gradient-to-b from-rose-500 via-blue-400 to-violet-600 rounded-md m-4 flex justify-center items-center">
