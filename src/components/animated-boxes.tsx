        ...
        <>
            ...
            >
                <motion.div
                    ...
                    className="w-[4rem] h-[4rem] z--50 bg-light_white_2 rounded-xl absolute bottom-[30%] left-[25%]"
                ></motion.div>
                <motion.div
                    variants={BTvariants}
                    transition={{ repeat: Infinity, duration: 24, ease: "linear" }}
                    className="w-8 h-8 z--50 bg-light_white_2 rounded-md absolute top-[10%] left-[11%]"
                ></motion.div>
                <motion.div
                    variants={BTvariants}
                    transition={{ repeat: Infinity, duration: 13, ease: "linear" }}
                    className="w-32 h-32 z--50 bg-light_white_2 rounded-3xl absolute top-[20%] left-40"
                ></motion.div>
                <motion.div
                    variants={BTvariants}
                    transition={{ repeat: Infinity, duration: 8, ease: "linear" }}
                    className="w-16 h-16 z--50 bg-light_white_2  rounded-md absolute top-[55%] right-[30%]"
                ></motion.div>
                <motion.div
                    variants={BTvariants}
                    transition={{ repeat: Infinity, duration: 22, ease: "linear" }}
                    className="w-4 h-4 z--50 bg-light_white_2 rounded absolute bottom-[33%] right-[15%]"
                ></motion.div>
                <motion.div
                    variants={BTvariants}
                    transition={{ repeat: Infinity, duration: 30, ease: "linear" }}
                    className="w-[4rem] h-[4rem] z--50 bg-light_white_2 rounded-xl absolute bottom-40 left-[18%]"
                ></motion.div>
                <motion.div
                    variants={BTvariants}
                ...
                <motion.div
                    ...
                    className="w-32 h-32 z--50 bg-light_white_2 rounded-3xl absolute bottom-[40%] left-24"
                ></motion.div>
                <motion.div
                    variants={BTvariants}
                    transition={{ repeat: Infinity, duration: 10, ease: "linear" }}
                    className="w-16 h-16 z--50 bg-light_white_2  rounded-md absolute top-[10%] right-[30%]"
                ></motion.div>
                <motion.div
                    variants={BTvariants}
                ...
                <motion.div
                    variants={BTvariants}
                    transition={{ repeat: Infinity, duration: 12, ease: "linear" }}
                    className="w-6 h-6 z--50 bg-light_white_2 rounded absolute bottom-[30%] right-[40%]"
                ></motion.div>
                <motion.div
                    variants={BTvariants}
                    transition={{ repeat: Infinity, duration: 20, ease: "linear" }}
                ...
                <motion.div
                    variants={BTvariants}
                    transition={{ repeat: Infinity, duration: 18, ease: "linear" }}
                    className="w-[4rem] h-[4rem] z--50 bg-light_white_2 rounded-xl absolute bottom-32 left-[75%]"
                ></motion.div>
                <motion.div
                    variants={BTvariants}
                    transition={{ repeat: Infinity, duration: 25, ease: "linear" }}
